...
def get_documents(las_client: Client, dataset_id, output_dir, num_threads, chunk_size, max_elements):
    ...
    with ThreadPoolExecutor(max_workers=num_threads) as executor:
        ...
        for document in _list_all_documents_in_dataset(las_client, dataset_id):
            ...
            if max_elements and max_elements <= len(documents):
                break
...
def create_datasets_parser(subparsers):
    ...
    get_documents_parser.add_argument('--max-elements', default=0, type=int)
