...
def create_secret(las_client: Client, data, description):
    secret_data = {}
...
def create_secrets_parser(subparsers):
    ...
    create_secret_parser.add_argument('--description', default=None)
    ...
    update_secret_parser.add_argument('--description', default=None)
